...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
              Wireless INFRA: Pending Task Search By Employee ID
            </h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/wi_controller/wi_pending_task_by_id/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
