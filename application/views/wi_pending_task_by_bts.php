...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
              Wireless INFRA: Pending Task Search By BTS
            </h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/wi_controller/wi_pending_task_by_bts/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
            ...
            <?php } ?>
                    ...
                    <div class="col-lg-3" style="">
                        <div class="form-group">
                            <label>BTS/POP Name: <div style="color:red;float: right;">*</div></label>
                            ...
                            <select class="form-control" name="BTS_name" id="BTS_name" onchange="pick_engineer_id()"  required="">
                                 <option value="">Select BTS/POP Name</option>
                            </select>
                        </div>
                    </div>
<!--                    <div class="col-lg-3" style="">
...
<script>
    $(function() {		
            $("#Division").change(function() {
                    $("#BTS_name").load("<?php echo base_url(); ?>BTS_list/" + $(this).val() + ".txt");
            });
    });
</script>
<script>
    $(function() {		
                var MTU_Zone = $('#MTU_Zone').val();
                    $("#BTS_name").load("<?php echo base_url(); ?>BTS_list/" + MTU_Zone + ".txt");
    });
</script>
