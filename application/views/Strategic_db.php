...
//                   echo ' DashBoard '.$department;
    ...
    <div class="row">
        <div class="col-lg-12">
<?php if ( $department == 'Corporate' || $department == 'Strategic' || $department == 'Admin' ) {
...
<?php if ($department == 'Strategic' || $department == "Admin" ) { ?>   
                       <h3> Strategic Task (Yesterday: <?php echo $yesterday=date('Y-m-d',strtotime("-1 days"));?> )</h3>
        <!--</h3>-->
...
//                                                        
        ...
        <h3> Strategic Task (Previous Week :
            <?php
...
<?php if ($department == "Admin" ||  $department=='Strategic') { ?>   
                        <h3> Strategic Sales (Monthly in
                        <?php
                            $month = date('m');
                            if($month == 1){
                               echo "January";
...
<?php if ($department == "Admin" || $department == "Strategic") { 
    if( $user_type=='s_user' || $user_type == 'admin'){
    ?>   
                        <h3> Strategic Sales Year(2019-2020 ) </h3>
                      <table class="table table-bordered table-hover">                          
                            <thead>
                                <tr>
                                    <th>Month</th>
