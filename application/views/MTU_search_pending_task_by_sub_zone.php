...
<!--            <form action="" name="CS_task_from" id="CS_task_from" method="">
    ...
    <form action="<?php echo base_url('index.php/ipts_controller/MTU_search_pending_task_by_sub_zone/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
       <div class="row">
        <div class="col-lg-3"> 
                        <div class="form-group">
...
<!--                            <select class="form-control" name="Zone" id="Zone" required="">
                            ...
                            <input class="form-control" readonly="readonly" name="Zone" id="Zone" value="<?php echo $zone = $this->session->userdata('Zone');?>" required="">
                        </div>
        </div>
...
//            $("#Zone").(function() {
                var Zone = $('#Zone').val();
//                alert(Zone);
                    $("#Sub_Zone").load("<?php echo base_url(); ?>CS_sub_zone_list/" + Zone + ".txt");
//            });
    });
</script>
