...
<div class="container-fluid" onload="myFunction()">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
        <form action="<?php echo base_url() ?>index.php/wi_controller/wi_done_from" name="assign_task_from" id="assign_task_from" method="POST">
        ...
        <input type="hidden" id="Division" name="Division" value="<?php echo $pending_task_result->Division; ?>"> 
...
<!--                            <select class="form-control" name="Final_Resolution" id="Final_Resolution" >
                                <option value="">Select Final Resolution</option>
                            </select>-->
                            <input type="text"  class="form-control" id="Final_Resolution" name="Final_Resolution" required="">
                        
                        </div>
                    </div> 
                    <div class="col-lg-3">
                        <div class="form-group">
                          <label>Support Complete date & time <div style="color:red;float: right;"></div><i class="fa fa-calendar"></i><div style="color:red;float: right;">*</div></label>
