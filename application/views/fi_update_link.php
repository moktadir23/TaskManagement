...
<div class="container-fluid" onload="myFunction()">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
             Fiber INFRA  :
             <?php $type_task=$pending_task_result->type_task; 
    ...
    <div class="row">
        ...
        <input type="hidden" class="form-control" id="type_task" name="type_task" value="<?php echo $pending_task_result->type_task; ?> "> 
...
<!--                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>link Completion Date & Time <i class="fa fa-calendar"></i><div style="color:red;float: right;">*</div></label>
        ...
        <input type="hidden" class="form-control" name="support_type_array" id="support_type_array">
...
//        alert(status);
 ...
 if( status == '2'){
    alert('you already update Physical Link Information that TKI');
...
//        exit();
        ...
        {
            alert('Please ADD Engineer Name and Technician Name');
            exit();
        }else{
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/fi_controller/fi_update_new_comments/'); ?>",
            type: 'POST',
            data: formData,
            async: false,
...
//            alert('Please Insert details !');
     ...
     document.getElementById("support_type"+y).disabled=true; 
    }
...
//   style="visibility:hidden;"  
    ...
    cell3.innerHTML = cell3.innerHTML +'<select class="form-control" name="support_type'+SerialNumber_clicks+'" id="support_type'+SerialNumber_clicks+'"  required=""><option value="">Select Support Type</option><option value="Physical">Physical Support</option><option value="Over_Phone">Over Phone Support</option></select>';
    
    var cell4 = row.insertCell(3);
    cell4.innerHTML = cell4.innerHTML +'<input type="text" name="details'+SerialNumber_clicks+'"  id="details'+SerialNumber_clicks+'" value="" class="form-control required" required="">';
//     alert(clicks);
...
//alert('loop'+loop);
     ...
     support_type_js[loop] = $("#support_type"+loop).val();
     


document.getElementById("Engineer_name"+loop).disabled = true;
document.getElementById("support_type"+loop).disabled = true;
...
//    alert('TEST ..' + Engineer_name_js +'.....' + Engineer_ID_js + ' ...... ' + support_type_js);
     ...
     document.getElementById("support_type_array").value=support_type_js;
