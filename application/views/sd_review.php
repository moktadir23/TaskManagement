                ...
                <div class="row"> 
                    <div class="col-lg-3">                                
                        <div class="form-group">
                            <label>Employee ID<div style="color:red;float: right;">*</div> <i class="fa fa-calendar"></i></label>                                  
                            <input name="Employee_ID" id="Employee_ID" class="form-control" value="" placeholder="Enter TKI ID"/>  
                        </div>
                    </div>
                   <div class="col-lg-3">                                
                        <div class="form-group">
