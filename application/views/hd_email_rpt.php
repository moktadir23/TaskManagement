...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/hd_controller/hd_email_report/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
...
<!--                        sift 1 :<input type="radio" name="time" id="time" value="08:00:00-15:59:59"> 
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th>Engineer Name(ID)</th>
                            <th>Email Time</th>
                            <th>Email Address</th>
                            <th>Subject</th>
                            <th>Client Name</th>
                            <th>TKI Generate Time</th>
                            <th>TKI ID</th>
                            <th>Repy/Forward Time</th>
                            <th>Reason</th>
                            <th>Remarks</th>
                        </tr>
                    </thead>
...
?>  
                        <tr> 
                                ...
                                <td><?php echo $value['email_time']; ?></td>
                                <td><?php echo $value['email']; ?></td>
                                <td><?php echo $value['subject']; ?></td>
                                <td><?php echo $value['client_name']; ?></td>
                                <td><?php echo $value['tki_time']; ?></td>
                                <td><?php echo $value['tki_id']; ?></td>
                                <td><?php echo $value['reply_time']; ?></td>
                                <td><?php echo $value['reason']; ?></td>
                                <td><?php echo $value['email_remarks']; ?></td>
                            </tr>                    
<?php } ?>
<div class="row">
