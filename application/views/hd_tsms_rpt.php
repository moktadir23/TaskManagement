...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/hd_controller/hd_tsms_report/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
...
?>  
                        <tr> 
                                ...
                                <td><?php echo $value['soi']; ?></td>
                                <td><?php echo $value['mobile']; ?></td>
                                <td><?php echo $value['Client_id']; ?></td>
                                <td><?php echo $value['sms_time']; ?></td>
