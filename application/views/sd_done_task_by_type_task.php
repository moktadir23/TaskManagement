...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
              SD: Done Task Search By Type Task
            </h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/sd_controller/sd_done_task_by_type_task/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
