...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/hd_controller/hd_pon_report/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>OLT</th>
                            <th>PON/Port</th>
                            <th>MIS Client Number</th>                                       
                            <th>MQ Client Number</th>  
                            <th>Total</th>  
                            <!--<th>Zone</th>-->
                            <th>Name (ID)</th>
                            <th>Remarks</th>
...
?>  
                        <tr> 
                                ...
                                <td><?php echo $value['olt']; ?></td>
                                <td><?php echo $value['pon_port']; ?></td>
                                <td><?php echo $value['mis_n']; ?></td>
                                <td><?php echo $value['mq_n']; ?></td>
