...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
              IPTS Team: Done Task Search By Employee ID
            </h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/ipts_controller/ipts_done_task_by_id/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
...
<div class="col-lg-10"></div> 
    <div class="col-lg-2">
         <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo base_url(); ?>index.php/ipts_controller/createXLS_report_by_Employee_ID/<?php echo $value['Engineer_ID']; ?>'">Export Excel</button> &nbsp;<br><br>  
