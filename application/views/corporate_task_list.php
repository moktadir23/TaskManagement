...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                <form action="<?php echo base_url('index.php/corporate_c/corporate_task_list/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
...
//                            $p_key = $value->id;
                            ...
                            <tr> 
                                ...
                                <td>
                                    <?php if($status != 'Sales Close'){?>
                                    <button type="button"  class="btn btn-primary" onclick="location.href = '<?php echo base_url(); ?>index.php/corporate_c/corporate_followup_from/<?php echo $value->p_key; ?>'" /> Update</button>
                                    <?php } ?>
                                </td>
                            </tr>   
                        <?php }
