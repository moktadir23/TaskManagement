...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
              IPTS Team: Done Task Search By Date
            </h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form action="<?php echo base_url('index.php/ipts_controller/ipts_done_task_by_date/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
                <div class="row">
