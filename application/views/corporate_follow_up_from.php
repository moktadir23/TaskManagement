            ...
            <form action="" name="assign_task_from" id="assign_task_from" method="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6"> <br>   
                        <input class="form-control" type="hidden" name="a_v" id="a_v">
                         <input class="form-control" type="hidden" name="cloud_v" id="cloud_v">
                         <input class="form-control" type="hidden" name="IPTS_v" id="IPTS_v">
                         <input class="form-control" type="hidden" name="intrnt_v" id="intrnt_v">
                            <b> Cross Sales :&nbsp; &nbsp;</b>  
                            <b> Anti Virus </b>&nbsp;<input type="checkbox" onchange="chk_a_v()" name="anti_v" id="anti_v">  &nbsp; &nbsp;
                            <b> Cloud</b>&nbsp;<input type="checkbox" onchange="chk_cloud()" name="cloud" id="cloud">  &nbsp; &nbsp;
                            <b> IPTS</b>&nbsp;<input type="checkbox" onchange="chk_IPTS()" name="IPTS" id="IPTS">  &nbsp; &nbsp;
                            <b> Internet</b> &nbsp;<input type="checkbox" onchange="chk_intrnt()" name="intrnt" id="intrnt">  &nbsp;
...
//        exit();
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/corporate_c/save_follow_up_info/'); ?>",
            type: 'POST',
            data: formData,
            async: false,
...
<script type="text/javascript">
    function chk_follow_up(){
        ...
        var x = document.forms["assign_task_from"]["sale_amount"].value;
        if(status=='Sales Close'){
            if (x == null || x == "") {
                document.getElementById("info_span").innerHTML = "Please Insert Sales Amount";
                document.getElementById("status").selectedIndex = 0;
                exit();
            }
        }
