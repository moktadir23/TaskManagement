                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3" style="">
                               <h4>  ID :  <?php echo $_SESSION["id"];?> </a> </h4>
                            </div>                           
...
<!--                            <div class="col-lg-4">
                        ...
                        <form action="<?php echo base_url();?>index.php/welcome/find_task_info_funcation" method="post">
                        <div class="row">
                            <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="from" class="form-control" placeholder="Enter From Date"/>
                            </div>
                            <div class="col-lg-4">
                                <label>To Date</label>
                                <input type="text" name="to" class="form-control" placeholder="Enter To Date"/>
                            </div>
