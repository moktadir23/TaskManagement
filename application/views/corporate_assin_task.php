        ...
        <div class="col-lg-12">
            <form action="" name="assign_task_from" id="assign_task_from" method="">
                ...
                <div class='row'>
                   ...
                   <div class="col-lg-3"> 
                        <div class="form-group">
                            <label> Area  <div style="color:red;float: right;">*</div></label>     
                ...
                <div class='row'>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                          <label>Contact Title<div style="color:red;float: right;">*</div></label>
                           <select class="form-control" name="Contact_TName" id="Contact_TName" required="">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                          <label>Contact First Name<div style="color:red;float: right;">*</div></label>
                            <input class="form-control" name="Contact_FName" id="Contact_FName" placeholder="Enter Contact First Name" required="">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                          <label>Contact Last Name<div style="color:red;float: right;"></div></label>
                            <input class="form-control" name="Contact_LName" id="Contact_LName" placeholder="Enter Contact Last Name" > 
                        </div>
                    </div>
...
//        exit();
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/corporate_c/save_corporate_task_info_/'); ?>",
            type: 'POST',
            data: formData,
            async: false,
