...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-lg-12">
            <form  name="assign_task_from" action="<?php echo base_url(); ?>index.php/hd_controller/save_email_info/" id="assign_task_from" enctype="multipart/form-data" method="POST">
                <div class='row'>
                    <div class="col-lg-3">                            
                        <div class="form-group">
                            <label>Email time <i class="fa fa-calendar"></i> <div style="color:red;float: right;"> *</div></label>
