...
//                   echo ' DashBoard '.$department;
    ...
    <div class="row">
        <div class="col-lg-12">
<?php if ( $department == 'Bank_NBFI' || $department == 'Admin' ) {
    if ( $user_type == 'admin' ) {   ?>        
                <div class="row">
...
<?php if ($department == "Admin" ||  $department=='Bank_NBFI') { ?>   
                       <h3> Bank_NBFI Task (Yesterday: <?php echo $yesterday=date('Y-m-d',strtotime("-1 days"));?> )</h3>
        <!--</h3>-->
...
//                                                        
        ...
        <h3> Bank_NBFI Task (Previous Week :
            <?php
...
//                            print_r($task_Details);  
        ...
        <!--...............................................................................................................-->
        <h3> Bank_NBFI Task (Previous Month :
            <?php
...
<?php if ($department == "Admin" || $department == "Bank_NBFI") { 
    if( $user_type=='s_user' || $user_type == 'admin'){
    ?>   
                        <h3> Bank_NBFI Sales Year(2019-2020 ) </h3>
                      <table class="table table-bordered table-hover">                          
                            <thead>
                                <tr>
                                    <th>Month</th>
            ...
            <div class="modal-header">
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-8 col-sm-8">
                        <h4 class="modal-title">Bank_NBFI Sales (Monthly in ....)</h4>
                    </div>           
                </div>             
            </div>
...
<script>
 ...
 function details_suooprt(row){
    ...
    $.post('<?php echo base_url();?>index.php/corporate_c/bank_dy_month', {
        month:month,  
