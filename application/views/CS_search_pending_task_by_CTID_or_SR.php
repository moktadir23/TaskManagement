...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
              Search Pending Task by CTID Number/SR Number
            </h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
<div class="row">
    <form action="<?php echo base_url('index.php/welcome/search_cs_pending_task_by_CTID_SR/'); ?>" name="search_by_zone" id="search_by_zone" method="POST">
        <div class="col-lg-3" style="">
            <div class="form-group">
                <label>Search By CTID Number/SR : <div style="color:red;float: right;">*</div></label>
