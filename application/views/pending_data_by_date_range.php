                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Search by Date Range for Pending Task
                        </h1>
...
<!--                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="<?php echo base_url();?>index.php/welcome/pending_data_by_date_range" method="post" >
                            <div class="row">
                                <div class="col-lg-3">
...
//$interval = date_diff($datetime1, $datetime2);
                                     ...
                                     '' .'<a href="'.base_url().'index.php/welcome/update_task_done_funcation/'.$value->ticket_no .'">'.'<button>Done Task</button>' .'</a>'.
