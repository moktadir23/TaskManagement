...
//$empInfo = $this->registration_model->excel_done_task_List();

//echo '<pre>';
//print_r("TEST Excel".$objPHPExcel);
...
//
//    $dbdata = array(
//                array("name"=>"MOktadir", "phone"=>"1010101001"),
//                array("name"=>"Sabbir", "phone"=>"1010101002")
//            );
// 
...
//    $objPHPExcel->getActiveSheet()->setCellValue('B1',"Sub_Zone"); 
...
////        $objPHPExcel->getActiveSheet()->SetCellValue('A' . $i, $element['Client_Name']);
////        $objPHPExcel->getActiveSheet()->SetCellValue('B' . $i, $element['Sub_Zone']);
////        $objPHPExcel->getActiveSheet()->SetCellValue('C' . $i, $element['Engineer_Name']);
////        $objPHPExcel->getActiveSheet()->SetCellValue('D' . $i, $element['CS_status_of_TKI']);
//        
//        $i++;
//    }
//    
